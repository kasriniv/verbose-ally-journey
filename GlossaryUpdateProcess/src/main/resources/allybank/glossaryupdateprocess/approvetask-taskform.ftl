<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("Glossary");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid Glossary");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: GlossarychangeProcess.approvetask
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[[users:bpmsAdmin|groups:]@[5m]]]>
                            		</div>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[[from:|tousers:bpmsAdmin|togroups:|replyTo:|subject:Please work|body:on this Glossary approval request]@[5m]]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Glossary" type="text" class="textbox" id="Glossary" value="${Glossary}" />
                            		</div>
